...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        // nextLine() gets skipped when placed after nextInt(), nextDouble(), nextLong(), and next()
        ...
        System.out.print("\nEnter a greeting: ");
        // Gets skipped bc of nextLine()
        // nextLine() reads the empty space after the variable
        scanner.nextLine(); // throwaway nextLine() to consume the empty space
        ...
        // next() example
        System.out.print("\nEnter three colors: ");
        // .next() looks for literally whatever and separates them with a space
